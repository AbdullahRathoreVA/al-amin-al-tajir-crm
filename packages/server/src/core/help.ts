...
export const HELP: HelpTopic[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'The age ranges come from the centre’s own licence: Infant 12–19 months, Toddler 19–36 months, Pre-school 3–4 and 4–5 years, and Kindergarten age 5–6 with out-of-school care for Grades 1–6.',
      'Free places are counted against the room’s own capacity when one is set, and otherwise against the licensed places for that age range — 28 infant, 76 toddler, 46 for 3–4, 54 for 4–5, 74 for Kindergarten and out-of-school care.',
    ],
